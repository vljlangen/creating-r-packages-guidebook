...
You can write these functions in any R environment, such as RStudio. Below is a screenshot of writing these functions in RStudio. Further down on this page, you will find the code in a text format, which you can copy and paste into your editor.

\

![](pics/example_functions.png)
...
![](pics/copy_paste_functions_to_vcode.png)
