...
explore how to use pkgdown to generate a comprehensive website for your
R package. This website will include documentation, vignettes, function
references, and more, making it easier for users and collaborators to
explore and understand your package.
...
2.  **Generate the website**: Run the following command to generate the
    website:
...
3.  **View the website:** After running `pkgdown::build_site()`, the
